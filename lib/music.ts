...
export function buildEmbedUrl(id: number): string {
  return `https://bandcamp.com/EmbeddedPlayer/album=${id}/size=large/bgcol=fafaf8/linkcol=d97706/tracklist=false/artwork=small/`;
}
